/**
 * Webview-based chat panel for the MCP Assistant sidebar.
 */
import * as vscode from 'vscode';
import { MCPBridge, MCPCommandResult } from './bridge';
...
export class MCPChatViewProvider implements vscode.WebviewViewProvider {
    ...
    constructor(extensionUri: vscode.Uri, bridge: MCPBridge, outputChannel: vscode.OutputChannel) {
     ...
     */
    postResult(input: string, result: MCPCommandResult) {
        if (this.view) {
